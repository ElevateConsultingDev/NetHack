...
- **Status (2026-09-24): loot half done (loop iteration 24).** Objects seen within 7 squares of a shopkeeper are never loot targets. Looting toward shop stock while the shopkeeper drifted in and out of view ping-ponged with explore for thousands of turns (7 of 64 games showed it in their last 100 feed lines). Rules 64 games: seed 1000 20260924-124821 -> 20260924-150821 deepest +0.59 +/- 0.23 (real); held-out seed 5000 20260924-151031 -> 20260924-151210 deepest +0.98 +/- 0.26, XL +0.28 +/- 0.14 (both real). Found by looking for effort without progress (tiny known map, most turns spent exploring and looting). Not done: paying for or dropping unpaid items.
- **Layer:** engine · **Effort:** small
...
- **Status (2026-09-24): blacklist done (loop iteration 23).** Species come from src/monst.c: never M1_POIS or M1_ACID (giant beetle and acid blob had been on the old safe list), never own race (M2_ flags), never a short list (stoning, sliming, aggravation, stun, hallucination, polymorph, teleport, mimicry, zombies, mummies). Rules 64 games seed 1000 20260924-121902 -> 20260924-124821: deepest 4.52 -> 4.73, XL 4.19 -> 4.33, hunger endings 19 -> 18, corpses eaten 447 -> 535. Marginal (within noise). Not done: throw-kill tracking (tried in iteration 20), lizard reserve.
- **Layer:** engine · **Effort:** medium
